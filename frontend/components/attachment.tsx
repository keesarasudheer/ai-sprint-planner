/* eslint-disable @typescript-eslint/ban-ts-comment, react-hooks/set-state-in-effect, @next/next/no-img-element */
// @ts-nocheck — auto-generated by assistant-ui CLI; render/delayMs type mismatch with base-ui shadcn
"use client";
